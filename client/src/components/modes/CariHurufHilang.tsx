  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-32 left-1/2 -translate-x-1/2 z-10">
        <div className="bg-gradient-to-r from-orange-400 to-red-500 rounded-3xl px-8 py-6 shadow-2xl">
          <p className="text-white text-2xl font-bold mb-4 text-center">
            Huruf apa yang hilang? {currentAnimal.emoji}
          </p>
          <p className="text-6xl font-bold text-white text-center tracking-widest">
            {displayName}
          </p>
        </div>
      </div>
